...
// COOKIES : petit fichier texte généré, ils sont un mécanisme d'enregistrement d'information sur le client, et de lecture de ces informations. Ce système  permet d'identifier et de suivre les visiteurs. Les cookies font partie des en-têtes HTTP. Ils sont associés à un ID de session spécifique. 
//possibilité de cookies obligatoires qui font fonctionner les applications